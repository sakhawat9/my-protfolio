      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto">
            ...
            <Nav.Link style={{color: '#fff'}} target="_blank" download href="https://drive.google.com/file/d/1BzpVoR3OadSYNQVzQEF8bMCx-N44GBnI/view?usp=sharing" className="active btn-brand p-0 px-2" >Resume </Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
